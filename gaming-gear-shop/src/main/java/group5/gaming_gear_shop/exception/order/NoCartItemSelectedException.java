...
@Getter
@Setter
public class NoCartItemSelectedException extends RuntimeException implements BaseCustomException {
    private final ErrorCode errorCode;

    public NoCartItemSelectedException(ErrorCode errorCode) {
